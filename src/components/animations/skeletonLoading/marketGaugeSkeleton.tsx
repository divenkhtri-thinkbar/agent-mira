...
export function SkeletonMarketGauge({
    selectedMarketAnalysisOption, propertyInfo, isAPILoading
        ...
        <>
            <div className="overflow-hidden">
                ...
                <div className="flex gap-1">
                    {[
                        { text: "County", isFirst: true },
                        { text: "City", isFirst: false },
                        { text: "Home Category", isFirst: false },
                    ].map(({ text, isFirst }, idx) => (
                        <div
                            key={idx}
                            className={`flex-1 h-10 ${isFirst ? "bg-[#E5E5E5]" : "bg-[#E5E5E5]/20"
                                } rounded-t-lg animate-pulse flex items-center justify-center`}
                        >
                            <span
                                className={`font-[ClashDisplay-Medium] text-[#FFFFFF] ${isFirst ? "text-lg" : "text-sm"
                                    }`}
                            >
                                {text}
                            </span>
                ...
                <div className="bg-[#E5E5E5] border-4 border-[#E5E5E5] rounded-r-[10px] relative overflow-hidden">
                    <div className="relative w-full flex justify-center items-center">
                        ...
                        {propertyInfo?.images?.length > 0 ? (
                            ...
                            <div className="flex flex-col gap-4 w-full px-4 h-[250px] items-center justify-center">
                                <div className="w-full bg-gray-200 rounded-3xl flex items-center justify-center">
