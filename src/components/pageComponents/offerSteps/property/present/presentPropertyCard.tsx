...
export function PresentPropertyCard({
  ...
  return (
    <div className="flex flex-col px-14 py-4 w-full h-full items-center justify-center">
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="flex justify-between items-start px-0">
            <div className="flex items-center gap-2">
              <div className="px-3 py-2 rounded-full bg-blue-6a00 flex items-center justify-center">
            ...
            <div className="flex items-center gap-2">
              <div className="px-3 py-2 rounded-full bg-blue-600 flex items-center justify-center">
      ...
      <Card className="max-w-3xl w-full mx-auto overflow-hidden bg-[#D3E4FF] rounded-none relative z-0 -mt-16">
